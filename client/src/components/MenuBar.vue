<template>
    <div class="menu-bar">
        ...
        <div class="weather">
            <p v-if="weather">
                {{ weather.city }}, {{ weather.state }}: {{ weather.temperature }}°F, {{ weather.shortForecast }}
            </p>
    ...
    methods: {
        async fetchWeather() {
            try {
                ...
                const city = pointResponse.data.properties.relativeLocation.properties.city;
                const state = pointResponse.data.properties.relativeLocation.properties.state;
